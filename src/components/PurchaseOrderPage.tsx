                      ...
                      <div className="flex gap-4 mb-3 text-xs">
                        ...
                        <div className="w-[200px] border border-gray-300 rounded p-2 text-xs flex-shrink-0">
                          ...
                          <div className="grid grid-cols-[45px_1fr] gap-y-0.5 items-center">
                            ...
                            <EditableInput value={data.orderer.registrationNumber} onChange={(v) => setData({...data, orderer: {...data.orderer, registrationNumber: v}})} />
                          ...
                          if (row.type === 'total') {
                            return (
                              <tr key="total" className="bg-blue-100 font-bold">
                                ...
                                <td className="border border-black p-2 text-right text-blue-600">{data.total.toLocaleString()}</td>
                                <td className="border border-black p-2"></td>
                                <td className="border-0 print:hidden" data-html2canvas-ignore></td>
                              </tr>
                            );
